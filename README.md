...
| 7   | Resend-Zugangsdaten                                    | `.env.local` (Vorlage: `.env.example`)        | Ohne die drei Variablen fällt das Formular sauber auf WhatsApp zurück — es geht also nichts verloren, aber Leads landen nicht im Postfach.                                                                    |
